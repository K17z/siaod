...
struct MinHeapNode{
    ...
    MinHeapNode* left, * right; // Левый и правый ребенок
...
// служебная функция для очереди приоритетов
struct compare{
...
// Очередь приоритетов STL для хранения дерева кучи
// к значению корневого узла кучи
priority_queue<MinHeapNode*, vector<MinHeapNode*>, compare> minHeap;
// функция для построения дерева Хаффмана и его сохранения
// в minHeap
...
// утилита для сохранения карты каждого символа с его
// частота во входной строке
